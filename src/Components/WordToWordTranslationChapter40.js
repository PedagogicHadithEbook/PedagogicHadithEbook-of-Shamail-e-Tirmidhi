...
export default function WordToWordTranslationChapter40() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter41 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter41')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[267,268,269,270,271,272,273,274]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 40. Salaatut Duha (Chaast Prayers)</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter40' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter40' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter41} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
