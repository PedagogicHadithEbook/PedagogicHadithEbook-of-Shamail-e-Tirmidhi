...
export default function WordToWordTranslationChapter52() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter53 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter53')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[354,355,356,357,358,359]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 52. The Noble Age Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter52' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter52' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter53} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
