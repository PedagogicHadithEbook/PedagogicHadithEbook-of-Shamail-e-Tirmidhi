...
export default function WordToWordTranslationChapter42() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter43 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter43')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[276,277,278,279,280,281,282,283,284,285,286,287,288,289,290]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 42. The Fasting Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter42' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter42' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter43} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
