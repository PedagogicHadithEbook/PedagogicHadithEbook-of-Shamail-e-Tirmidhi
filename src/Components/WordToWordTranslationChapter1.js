      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter1' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter1' +'/#Hadith'+(loop1+1)} style={{ color:"black"}}>View English Translation </HashLink></h6>
      </div>
