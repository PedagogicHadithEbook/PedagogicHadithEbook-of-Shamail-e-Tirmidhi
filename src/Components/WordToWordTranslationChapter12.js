...
export default function WordToWordTranslationChapter12() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter13 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter13')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[81,82,83,84,85,86,87,88]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 12. The Mubarak Ring Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter12' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter12' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter13} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
