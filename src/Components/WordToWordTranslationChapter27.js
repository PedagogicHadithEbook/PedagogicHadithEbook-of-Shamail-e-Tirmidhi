...
export default function WordToWordTranslationChapter27() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter28 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter28')
  } 
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 27. Rasoolullah Performing Wudu At The Time Of Eating</h2></center><br />
       ...
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <div className="Reference1">
           ...
           {/* eslint-disable-next-line */}
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter27' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter27' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter28} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
