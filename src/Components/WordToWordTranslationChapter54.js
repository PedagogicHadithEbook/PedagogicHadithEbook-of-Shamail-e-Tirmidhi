...
export default function WordToWordTranslationChapter54() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter55 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter55')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[374,375,376,377,378,379,380,381,382]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 54. The Legacy Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter54' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter54' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter55} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
