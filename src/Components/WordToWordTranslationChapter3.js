...
export default function WordToWordTranslationChapter3() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter4 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter4')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[22,23,24,25,26,27,28,29]
 ...
 //To change state of Checkbox
  ...
  <center><h2>Chapter 3. The Mubarak Hair Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter3' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter3' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter4} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
