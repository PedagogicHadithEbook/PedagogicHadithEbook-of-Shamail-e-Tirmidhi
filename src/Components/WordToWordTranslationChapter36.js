...
export default function WordToWordTranslationChapter36() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter37 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter37')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[221,222,223,224,225,226]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 36. Description Of The Joking Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter36' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter36' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div> 
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter37} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
