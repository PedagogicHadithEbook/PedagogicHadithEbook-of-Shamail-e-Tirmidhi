...
export default function WordToWordTranslationChapter24() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter25 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter25')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[128,129,130,131,132]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 24. Description Of The Eating Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter24' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter24' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter25} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
