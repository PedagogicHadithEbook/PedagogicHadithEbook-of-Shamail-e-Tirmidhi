...
export default function WordToWordTranslationChapter49() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter50 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter50')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[337,338,339,340,341,342]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 49. Hajaamah (Cupping-Cautering) Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter49' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter49' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter50} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
