...
export default function WordToWordTranslationChapter51() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter52 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter52')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[345,346,347,348,349,350,351,352,353]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 51. The Living Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter51' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter51' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter52} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
