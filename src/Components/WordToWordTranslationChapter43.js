...
export default function WordToWordTranslationChapter43() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter44 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter44')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[291,292,293,294,295,296,297,298]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 43. The Recital Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter43' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter43' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter44} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
