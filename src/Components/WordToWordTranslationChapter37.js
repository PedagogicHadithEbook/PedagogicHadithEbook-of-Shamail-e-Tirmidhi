...
export default function WordToWordTranslationChapter37() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter38 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter38')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[227,228,229,230,231,232,233,234,235,236]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 37. Description Of The Saying Of Rasoolullah On Poetry</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter37' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter37' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter38} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
