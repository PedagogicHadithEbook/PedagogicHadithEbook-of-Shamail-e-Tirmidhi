...
export default function WordToWordTranslationChapter32() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter33 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter33')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[194,195,196,197,198,199,200,201,202,203]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 32. Hadith Describing The Manner Rasoolullah Drank</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter32' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter32' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter33} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
