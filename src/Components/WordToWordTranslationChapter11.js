...
export default function WordToWordTranslationChapter11() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter12 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter12')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[70,71,72,73,74,75,76,77,78,79,80]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 11. The Shoes Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter11' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter11' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter12} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
