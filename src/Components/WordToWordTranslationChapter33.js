...
export default function WordToWordTranslationChapter33() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter34 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter34')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[204,205,206,207,208,209]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 33. Rasoolullah Using ‘Itr</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter33' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter33' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter34} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
