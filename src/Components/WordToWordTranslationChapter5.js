...
export default function WordToWordTranslationChapter5() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter6 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter6')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[35,36,37,38,39,40,41,42]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 5. Appearing Of The White Hair Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter5' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter5' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter6} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
