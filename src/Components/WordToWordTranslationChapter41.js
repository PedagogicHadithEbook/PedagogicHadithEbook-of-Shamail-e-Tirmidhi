...
export default function WordToWordTranslationChapter41() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter42 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter42')
  } 
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 41. Sayyidina Rasoolullah Performing Nawaafil At Home</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter41' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter41' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter42} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
