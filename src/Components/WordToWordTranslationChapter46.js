...
export default function WordToWordTranslationChapter46() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter47 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter47')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[306,307,308,309,310,311,312,313,314,315,316,317,318]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 46. The Humbleness Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter46' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter46' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter47} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
