...
export default function WordToWordTranslationChapter53() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter54 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter54')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[360,361,362,363,364,365,366,367,368,369,370,371,372,373]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 53. The Death Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter53' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter53' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter54} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
