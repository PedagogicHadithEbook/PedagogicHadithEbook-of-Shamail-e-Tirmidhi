...
export default function WordToWordTranslationChapter47() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter48 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter48')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[320,321,322,323,324,325,326,327,328,329,330,331,332,333,334,]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 47. Noble Character And Habits Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter47' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter47' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter48} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
