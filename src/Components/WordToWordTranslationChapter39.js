...
export default function WordToWordTranslationChapter39() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter40 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter40')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258,259,260,261,262,263,264,265,266]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 39. Worship And Devotion Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter39' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter39' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter40} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
