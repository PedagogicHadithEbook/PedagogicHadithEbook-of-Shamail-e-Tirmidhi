...
export default function WordToWordTranslationChapter35() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter36 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter36')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[213,214,215,216,217,218,219,220]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 35. The Laughing Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter35' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter35' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter36} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
