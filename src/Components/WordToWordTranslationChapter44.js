...
export default function WordToWordTranslationChapter44() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter45 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter45')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[299,300,301,302,303,304]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 44. The Weeping Of Sayyidina Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter44' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter44' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter45} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
