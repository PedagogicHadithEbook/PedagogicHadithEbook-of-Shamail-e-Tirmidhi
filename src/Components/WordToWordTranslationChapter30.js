...
export default function WordToWordTranslationChapter30() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter31 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter31')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[186,187,188,189,190,191]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 30. The Fruits Eaten By Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter30' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter30' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter31} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
