...
export default function WordToWordTranslationChapter55() {
 ...
 //styling for hover text
  ...
  const loop1=[383,384,385,386,387,388,389]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 55. The Seeing Of Rasoolullah In a Dream</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter55' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter55' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
