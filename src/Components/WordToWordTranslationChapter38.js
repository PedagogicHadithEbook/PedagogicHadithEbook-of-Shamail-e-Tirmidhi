...
export default function WordToWordTranslationChapter38() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter39 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter39')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[237,238,239,240,241,242]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 38. The Sleeping Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter38' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter38' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter39} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
