...
export default function WordToWordTranslationChapter17() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter18 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter18')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[106,107,108,109,110]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 17. The Turban Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter17' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter17' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter18} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
