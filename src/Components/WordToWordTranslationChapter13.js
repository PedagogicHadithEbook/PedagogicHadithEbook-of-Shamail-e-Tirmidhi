...
export default function WordToWordTranslationChapter13() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter14 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter14')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[89,90,91,92,93,94,95,96,97]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 13. Stating That Rasoolullah Wore The Ring On His Right Hand</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter13' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter13' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter14} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
