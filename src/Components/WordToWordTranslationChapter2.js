...
export default function WordToWordTranslationChapter2() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter3 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter3')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[14,15,16,17,18,19,20,21]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 2. Seal Of Nubuwwah (Prophethood) Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter2' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter2' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter3} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
