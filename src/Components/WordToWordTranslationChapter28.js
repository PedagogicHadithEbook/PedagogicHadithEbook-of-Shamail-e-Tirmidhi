...
export default function WordToWordTranslationChapter28() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter29 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter29')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[177,178,179,180,181,182,183]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 28. The Words That Of Rasoolullah Said Before and After Eating</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter28' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter28' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
              ...
              <tbody>
                {TabelRowContent.slice(hadith1[loop1].Sindexlafz, hadith1[loop1].Eindexlafz+1).map((item2,index2) => (
                 ...
                 <tr>
                  ...
                  { checkBox_label_array1.map((item, index) =>
                    (<td>{Whadith1[item2][checkBox_label_array[index]]}</td>))}
                 </tr>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter29} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
