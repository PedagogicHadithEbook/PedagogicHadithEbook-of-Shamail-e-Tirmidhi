...
export default function WordToWordTranslationChapter25() {

  const navigate = useNavigate();
  
  const WordToWordTranslationChapter26 = () => {
      navigate('/WordToWordTranslationChapters/WordToWordTranslationChapter26')
  } 
 ...
 //styling for hover text
  ...
  const loop1=[133,134,135,136,137,138,139,140]
 ...
 //To change state of Checkbox
  ...
  <div className="container">
    <center><h2>Chapter 25. The Bread Of Rasoolullah</h2></center><br />
      ...
      // if part
       <div>
        {/*loop1 is the Hadith NO 
         ...
         <h6><HashLink to={'/UrduTranslationChapters/UrduTranslationChapter25' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View Urdu Translation</HashLink></h6>
        {/* eslint-disable-next-line */}
         <h6><HashLink to={'/EnglishTranslationChapters/EnglishTranslationChapter25' +'/#Hadith'+(loop1+1)} style={{ color:"midnightblue"}}>View English Translation </HashLink></h6>
      </div>
         </div>
  ...
  <br />
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
           <button class="NextButton" type="button" onClick = {WordToWordTranslationChapter26} >View Next Chapter{'>>'}</button>
      </div>
  </>
  )
}
